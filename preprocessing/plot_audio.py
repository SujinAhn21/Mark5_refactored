...
def plot_waveform_and_mel(path, save_dir=None, seed_value=42, mark_version="mark5.0"):
    set_seed(seed_value)
...
if __name__ == "__main__":
    test_audio_file = os.path.join(PROJECT_ROOT, "data_wav", "daily_human_talking_50.wav")
